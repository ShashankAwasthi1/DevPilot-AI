...
test("deleteConversation: a service failure (e.g. the existing 404 for a nonexistent/foreign conversation) is forwarded to next(err), not swallowed or converted", async (t) => {
