...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('COMMENT_CREATED', 'DOCUMENT_CREATED', 'DOCUMENT_UPDATED', 'DOCUMENT_ARCHIVED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_COMMENT_CREATED');
...
-- CreateIndex
CREATE INDEX "documents_projectId_archivedAt_createdAt_idx" ON "documents"("projectId", "archivedAt", "createdAt");
